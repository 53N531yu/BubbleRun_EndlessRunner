class Title extends Phaser.Scene {
    ...
    create() {
        ...
        // let title01 = this.add.bitmapText(centerX, centerY, 'gem', 'BUBBLE RUN', 64).setOrigin(0.5).setTint(0xff0000);
        // let title02 = this.add.bitmapText(centerX, centerY, 'gem', 'BUBBLE RUN', 64).setOrigin(0.5).setTint(0xff00ff).setBlendMode('SCREEN');
        // let title03 = this.add.bitmapText(centerX, centerY, 'gem', 'BUBBLE RUN', 64).setOrigin(0.5).setTint(0xffff00).setBlendMode('ADD');
